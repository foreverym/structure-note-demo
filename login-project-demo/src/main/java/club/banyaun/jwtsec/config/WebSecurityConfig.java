...
import club.banyaun.jwtsec.filter.AuthenticationTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/task/*").hasAuthority("admin")// 需拥有 admin 这个权限
                //.antMatchers("/task/*").hasRole("ADMIN")     // 需拥有 ADMIN 这个身份
